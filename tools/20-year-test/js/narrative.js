  ...
  function episodeScript(sim, scores, seed) {
    ...
    beat('disclaimer', 'disclaimer', 'Before we start', 'The fine print',
      [pk('Quick housekeeping before we get into it.',
       ...
       pk('Every dollar you\'ll see is in today\'s dollars. The model runs inflation and I take it back out, so nothing is adjusted for the timeline. A wage at 57 sounds like a wage, not a lottery number.',
          'All the money is in today\'s dollars, not adjusted for the timeline. Inflation is in the model, but I strip it back out before it hits the screen, so the numbers mean what they\'d mean today.',
          'One more thing. Every number is in today\'s dollars. Not adjusted for the timeline. If it says $133,000 at 57, that\'s $133,000 of today\'s buying power.'),
